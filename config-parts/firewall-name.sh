...
set firewall ipv6-name wan-local rule 1 description 'Rule: accept_wireguard'
set firewall ipv6-name wan-local rule 1 destination port '51820'
set firewall ipv6-name wan-local rule 1 protocol 'udp'
