...
# adguard-home
set container name adguard-home image 'docker.io/adguard/adguardhome:v0.107.12'
...
set container name adguard-home volume data source '/config/adguard-home/conf'
...
set container name coredns network services address '10.6.0.3'
