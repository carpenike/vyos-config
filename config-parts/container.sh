...
# Container networks
set container network services prefix '10.6.0.0/16'

# adguard-home
set container name adguard-home image 'docker.io/adguard/adguardhome:v0.107.29'
set container name adguard-home memory '0'
set container name adguard-home network services address '10.6.0.6'
...
set container name bind network services address '10.6.0.3'
...
set container name dnsdist network services address '10.6.0.4'
...
set container name haproxy-k8s-api network services address '10.6.0.2'
...
# set container name onepassword-connect network services address '10.6.0.5'
...
# set container name onepassword-sync network services address '10.6.0.7'
