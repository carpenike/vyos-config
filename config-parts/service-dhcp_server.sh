...
set service dhcp-server shared-network-name SERVERS subnet 10.20.0.0/16 static-mapping fh ip-address '10.20.0.5'
set service dhcp-server shared-network-name SERVERS subnet 10.20.0.0/16 static-mapping fh mac-address '52:54:00:d0:81:38'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 range 0 start '10.30.0.50'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping miele-dishwasher ip-address '10.30.100.198'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-bar ip-address '10.30.100.50'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-basement ip-address '10.30.100.51'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-move ip-address '10.30.100.52'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-office ip-address '10.30.100.53'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-kitchen ip-address '10.30.100.54'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-tv ip-address '10.30.100.55'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-master-bedroom-tv ip-address '10.30.100.56'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-upstairs-hallway ip-address '10.30.100.57'
...
# set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-1 static-mapping-parameters "ddns-hostname sonos-livingroom;"
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-1 ip-address '10.30.100.58'
set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-1 mac-address '34:7e:5c:1e:04:4c'

# set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-2 static-mapping-parameters "ddns-hostname sonos-livingroom;"
# set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-2 ip-address '10.30.100.59'
# set service dhcp-server shared-network-name WIRELESS subnet 10.30.0.0/16 static-mapping sonos-livingroom-2 mac-address '34:7e:5c:1e:04:4c'
