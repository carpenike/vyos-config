...
set interfaces wireguard wg01 peer iphone-ryan public-key 'Ymk1bjdKSGhnM1NOWi9CSE9TN0Y5OW91MzlOS3Q4TDJSbUNOektMaU93ND09Cg=='
set interfaces wireguard wg01 peer rymac allowed-ips '10.0.11.2/32'
set interfaces wireguard wg01 peer rymac persistent-keepalive '15'
set interfaces wireguard wg01 peer rymac public-key 'LzhLZDVFOUdwd3dZK0tkUjVkaE9adVIrVERxTWNPZ1hBT205azdwNXpVMD0K'
