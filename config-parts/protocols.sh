...
set protocols bgp neighbor 10.20.10.21 description 'node-0'
set protocols bgp neighbor 10.20.10.21 remote-as '64512'
set protocols bgp neighbor 10.20.10.22 address-family ipv4-unicast
set protocols bgp neighbor 10.20.10.22 description 'node-1'
set protocols bgp neighbor 10.20.10.22 remote-as '64512'
set protocols bgp neighbor 10.20.10.23 address-family ipv4-unicast
set protocols bgp neighbor 10.20.10.23 description 'node-2'
set protocols bgp neighbor 10.20.10.23 remote-as '64512'
set protocols bgp neighbor 10.20.10.24 address-family ipv4-unicast
set protocols bgp neighbor 10.20.10.24 description 'node-3'
set protocols bgp neighbor 10.20.10.24 remote-as '64512'
