...
# set firewall zone wireless from guest firewall name 'guest-trusted'
# set firewall zone wireless from iot firewall name 'iot-trusted'
# set firewall zone wireless from lan firewall name 'lan-trusted'
set firewall zone wireless from local firewall name 'local-wireless'
# set firewall zone wireless from servers firewall name 'servers-trusted'
# set firewall zone wireless from services firewall name 'services-trusted'
# set firewall zone wireless from video firewall name 'video-trusted'
