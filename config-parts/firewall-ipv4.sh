...
set firewall ipv4 name guest-mgmt enable-default-log
...
set firewall ipv4 name wireless-iot enable-default-log
...
set firewall ipv4 name wireless-servers enable-default-log
...
set firewall ipv4 name wireless-mgmt enable-default-log
...
set firewall ipv4 name wireless-video enable-default-log
...
set firewall ipv4 name servers-wireless enable-default-log
...
set firewall ipv4 name servers-mgmt enable-default-log
...
set firewall ipv4 name mgmt-guest enable-default-log
...
set firewall ipv4 name video-mgmt enable-default-log
